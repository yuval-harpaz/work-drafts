...
%         meg.trial=meg.trial(1,good);
%         meg.time=meg.time(1,good);
%         meg.sampleinfo=meg.sampleinfo(good,:);
        
        load ~/ft_BIU/matlab/files/neighbours7cm
        cfg=[];
        ...
        cfg=[];
        cfg.combinegrad  = 'yes';
        meg_cp = ft_combineplanar(cfg, interp)
%         cfg=[];
%         cfg.method='distance';
%         cfg.grad=meg.grad;
...
%        cfg.trials=good;
        ...
        cfg.feedback='no';
        %cfg.keeptrials='yes';
        megFr = ft_freqanalysis(cfg, meg_cp);
...
save /home/yuval/Copy/MEGdata/alpha/tal/planar/Open Open
save /home/yuval/Copy/MEGdata/alpha/tal/planar/Closed Closed
