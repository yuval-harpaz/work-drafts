...
for subi=1:length(subs)
    ...
    indiv=talIndivPathH(sub,'timeProd',pat);
    path2file=indiv.path1;
    clnsource= indiv.source1;
    cd(path2file)
    ...
    for trval=112;  %[84 88 96 112] reduce 80 to get interval in sec
        time0=find(trig==trval,1);
        epoched=time0:1017:time0+30*1017.25;
        cfg1=[];
        cfg1.dataset=clnsource;
        ...
        save(['/media/Elements/MEG/tal/s',sub,'_pow',num2str(trval)],'pow');
