...
load GavgM4
read=GavgM2;
read.individual=(GavgM2.individual+GavgM4.individual)./2;

cfg=[];
cfg.xlim=[0.13 0.13];
cfg.layout='4D248.lay';
cfg.interactive='yes';
ft_topoplotER(cfg,read);


chansL={'A161','A162'};
chansR={'A167','A168'};
[~,Li]=ismember(chansL,read.label);
[~,Ri]=ismember(chansR,read.label);
compSamp0=nearest(read.time,0.41);
compSamp1=nearest(read.time,0.48);
areaL=trapz(squeeze(mean(read.individual(:,Li,compSamp0:compSamp1),2))');
areaR=trapz(squeeze(mean(read.individual(:,Ri,compSamp0:compSamp1),2))');
[~,p]=ttest(areaL,areaR)

compSamp0=nearest(read.time,0.07);
compSamp1=nearest(read.time,0.11);
areaL=trapz(squeeze(mean(read.individual(:,Li,compSamp0:compSamp1),2))');
areaR=trapz(squeeze(mean(read.individual(:,Ri,compSamp0:compSamp1),2))');
[~,p]=ttest(areaL,areaR)

compSamp0=nearest(read.time,0.14);
compSamp1=nearest(read.time,0.24);
areaL=trapz(squeeze(mean(read.individual(:,Li,compSamp0:compSamp1),2))');
areaR=trapz(squeeze(mean(read.individual(:,Ri,compSamp0:compSamp1),2))');
[~,p]=ttest(areaL,areaR)
%% alpha flipped
compSamp0=nearest(gaM.time,0.41);
compSamp1=nearest(gaM.time,0.48);
areaL=trapz(erMl(:,compSamp0:compSamp1)');
areaR=trapz(erMr(:,compSamp0:compSamp1)');
[~,p]=ttest(areaL,areaR);

compSamp0=nearest(gaM.time,0.2);
areaL=trapz(alphaMl(:,compSamp0:end)');
areaR=trapz(alphaMr(:,compSamp0:end)');
[~,p]=ttest(areaL,areaR);



compSamp0=nearest(gaE.time,0.41);
compSamp1=nearest(gaE.time,0.48);
areaL=trapz(erEl(:,compSamp0:compSamp1)');
areaR=trapz(erEr(:,compSamp0:compSamp1)');
[~,p]=ttest(areaL,areaR)
...
areaL=trapz(squeeze(mean(GavgM20.individual(:,Li,compSamp0:compSamp1),2))');
areaR=trapz(squeeze(mean(GavgM20.individual(:,Ri,compSamp0:compSamp1),2))');
[~,p]=ttest(areaL,areaR)

compSamp0=nearest(GavgM20.time,0.07);
compSamp1=nearest(GavgM20.time,0.26);
areaL=trapz(squeeze(mean(GavgM20.individual(:,Li,compSamp0:compSamp1),2))');
areaR=trapz(squeeze(mean(GavgM20.individual(:,Ri,compSamp0:compSamp1),2))');
[~,p]=ttest(areaL,areaR)
