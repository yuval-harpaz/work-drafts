...
load avgFilt
[data, cfg]=marikViUnite(avg1_foot1,avg2_foot1,avg2_foot1);
save dataFoot1 data cfg
src=marikViMNE(data,cfg,[0.07 0.13]);

[data, cfg]=marikViUnite(avg1_foot2,avg2_foot2,avg3_foot2);
save dataFoot2 data cfg
src=marikViMNE(data,cfg,[0.11 0.13]);
figure;plot(data.dataU.time,data.dataU.avg,'k');

[data, cfg]=marikViUnite(avg1_hand2,avg2_hand2,avg3_hand2);
src=marikViMNE(data,cfg,[0.02 0.1]);

%%
load dataFilt data1_hand2 data2_hand2 data3_hand2
[data, cfg]=marikViUnite(data1_hand2,data2_hand2,data3_hand2);

src=marikViMNE(data,cfg,[0.02 0.04]);
src=marikViMNE(data,cfg,[0.02 0.1]);
